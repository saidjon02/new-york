...
function Home() {
  ...
  useEffect(() => {
    // Sayt yoki ma'lumot yuklanganidan so'ng loading ni to'xtatish
    setTimeout(() => {
      setLoading(false);
    }, 3000); // 3 soniya davomida loading ko'rsatiladi
  }, []);
    ...
    <div className="wrap">
      {loading ? (
        <div className="loader">
          <img src="https://i.pinimg.com/originals/dc/cc/84/dccc846959dffafa30a836dfacf9bab9.gif" alt="" />
        </div> // Loading spinner
      ) : (
        <div className="wrap2two">
          <Helmet>
          ...
          <div className="home-section container">
            <div className="home-row">
              <div className="home-box">
                ...
                <p className="hs-text">
                  New York is a city that never sleeps, offering a unique blend of culture, history,
                  and modernity. From the bustling streets of Manhattan to the serene beauty of
                  Central Park, there's something here for everyone. Discover the charm of this
                  iconic city and create memories that last a lifetime
                </p>
                <Link to={'/not'}>
            ...
            <div className="places">
              <div className="container">
                ...
                <p className="p-text">
                  ...
                  Brooklyn Bridge, admiring the art at the Metropolitan Museum, or enjoying the
                  skyline from the Empire State Building, you'll be captivated by the city's diverse
                  attractions. Explore the must-see landmarks and hidden gems that make New York
                  truly special.
                </p>
                <Link to={'/not'}>
          ...
          <div className="portfolio container">
            ...
            <p className="p-text">
              ...
              story. The city's famous landmarks, the bright lights of Times Square, the tranquility
              of Central Park, or the stunning view of the Brooklyn Bridge captivate every traveler.
            </p>
            ...
            <div className="home-section container">
              <div className="food-rowss">
                ...
                <div className="home-box">
                  ...
                  <p className="hs-text">
                    Donald Trump — 45-chi AQSh prezidenti, biznesmen, televidenie shaxsiyati va
                    ko‘chmas mulk magnati. U 1946-yil 14-iyunda Queens, New Yorkda tug‘ilgan. Trump
                    ko‘plab biznes imperiyalarini boshqarish, ko‘chmas mulk, mehmonxona va
                    o‘yin-kulgi sanoatlarida faoliyat yuritgan.
                  </p>
                  <Link to={'/not'}>
              ...
              <div className="food-rowss">
                <div className="home-box">
                  ...
                  <p className="hs-text">
                    ...
                    democracy worldwide, and it is a symbol of the United States. Given to the
                    United States by France in 1886 as a gift, the statue is located on Liberty
                    Island in New York and marks the entrance for visitors. The statue stands 93
                    meters tall, and the torch at the top can be imagined as a light representing
                    freedom.
                  </p>
                  <Link to={'/not'}>
            ...
            <div className="home-section container">
              <div className="food-rowss">
                ...
                <div className="home-box">
                  ...
                  <p className="hs-text">
                    The Brooklyn Bridge is one of the most famous and historic bridges in New York
                    City, built in 1883. It connects the Manhattan and Brooklyn boroughs and is one
                    of the oldest suspension bridges in the world. The bridge spans 1,834 meters and
                    stands out with its unique architecture and specially installed cable system.
                  </p>
                  <Link to={'/not'}>
            ...
            <div className="home-section container">
              <div className="food-rowss">
                <div className="home-box">
                  ...
                  <p className="hs-text">
                    World Trade Center's two twin towers (North Tower and South Tower) were built in
                    the 1970s and became an inseparable part of New York's skyline. On September 11,
                    2001, two airplanes crashed into the WTC, causing both buildings to collapse.
                    This event became one of the most tragic terrorist attacks in world history,
                    resulting in the loss of over 3,000 lives.
                  </p>
                  <Link to={'/not'}>
            ...
            <div className="home-section container">
              <div className="food-row">
                ...
                <div className="home-box">
                  ...
                  <p className="hs-text">
                    One World Trade Center (commonly referred to as the Freedom Tower) is a new
                    building constructed after the collapse of the two twin towers of the original
                    World Trade Center. Construction began in 2006, and the building was completed
                    in 2013. It is the tallest building in New York City.
                  </p>
                  <Link to={'/not'}>
            ...
            <div className="home-section container">
              <div className="food-row">
                <div className="home-box">
                  ...
                  <p className="hs-text">
                    Times Square is one of the most famous and vibrant places in New York, located
                    at the central part of Manhattan Island. It is situated at the intersection of
                    42nd Street and Broadway, making it one of the busiest and most iconic landmarks
                    in the city.
                  </p>
                  <Link to={'/not'}>
            ...
            <div className="home-section container">
              <div className="food-row">
                ...
                <div className="home-box">
                  ...
                  <p className="hs-text">
                    Indulge in New York's vibrant food scene, where every bite is a journey around
                    the world. From classic New York-style pizza to gourmet dishes crafted by
                    world-renowned chefs, the city offers a culinary experience like no other. Pair
                    it with Broadway shows and cultural festivals to truly embrace the spirit of New
                    York.
                  </p>
                  <Link to={'/not'}>
